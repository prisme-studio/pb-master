...
void Core::trackingEngineFinishedCycle(TrackingEngine *) {
	...
	Datagram * receiversDatagram = makeDatagram(DatagramType::partialBody);
	...
	for(pb::messages::PartialBody * message: _partialBodies) {
	...
	Datagram * terminalDatagram = makeDatagram(DatagramType::trackedBodies, *trackedBodies);
